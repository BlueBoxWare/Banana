...
var BananaLineView = new Lang.Class({
  Name: "BananaLineView",
  Extends: St.BoxLayout,

  _init: function(line) {
    this.parent({
      style_class: "banana-line-view"
    });

    if (typeof line !== "undefined") this.setLine(line);
  },
  ...
  setLine: function(line) {
    ...
    if (line.hasOwnProperty("image") || line.hasOwnProperty("templateImage")) {
      let image = line.hasOwnProperty("image")
        ? line.image
        : line.templateImage;
      ...
      try {
        ...
        let texture = St.TextureCache.get_default().load_gicon(
          null,
          pixbuf,
          size,
          1
